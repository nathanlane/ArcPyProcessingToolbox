...
def make_lists_to_process():
    ...
    all_noaanetcdf_list = [".".join([typeofnoaafile,str(i)]) for i in xrange(startyear, endyear)]
...
if __name__ == "__main__":
    ...
    yearlist_iterable=iter(xrange(startyear, endyear))
    ...
    for fileyear in yearlist_iterable:
        ...
        try:
            ...
            map(fill_raster_files, annual_raster_list)
